...
$consulta_reporte_asistencia = $conexion->query(" select asistencia.entrada,asistencia.salida,practicante.nombre,practicante.apellidop,practicante.apellidom,practicante.uak,area.nombre as 'nomarea' from asistencia
...
while ($datos_reporte = $consulta_reporte_asistencia->fetch_object()) {
   ...
   $pdf->Cell(30, 10, utf8_decode($datos_reporte->uak), 1, 0, 'C', 0);
   $pdf->Cell(50, 10, utf8_decode($datos_reporte->nomarea), 1, 0, 'C', 0);
