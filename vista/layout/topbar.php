...
<head>
    ...
    <head lang="es">
        ...
        <!-- font awesome -->
        <script src="https://kit.fontawesome.com/fa3efbfc58.js" crossorigin="anonymous"></script>
                    ...
                    <div class="site-header-content-in">
                        <div class="site-header-shown">
                            ...
                            <div class="dropdown dropdown-notification">
                                <h6 class="text-light mt-2" style="margin-top:.3rem">
                                <?= $_SESSION["nombre"] . " " . $_SESSION["apellidop"] . " " . $_SESSION["apellidom"] ?>
                                </h6>
                            </div>
                            ...
                            <div class="dropdown user-menu">
                                ...
                                <div class="dropdown-menu dropdown-menu-right pt-0" aria-labelledby="dd-user-menu">
                                    ...
                                    <h5 class="p-2 text-center bg-primary"><?= $_SESSION["nombre"] . " " . $_SESSION["apellidop"] . " " . $_SESSION["apellidom"] ?></h5> <!-- Muestra el nombre completo del usuario en la barra de navegacion -->
                                    <a class="dropdown-item" href="perfil.php"><span class="font-icon glyphicon glyphicon-user" style="color: #FF5841;"></span>Perfil</a>
                                    <a class="dropdown-item" href="cambiarclave.php"><span class="font-icon glyphicon glyphicon-lock" style="color: #FF5841;"></span>Cambiar contraseña</a>

                                    <div class="dropdown-divider"></div>
                                    <a class="dropdown-item" href="../controlador/LogOut.controller.php">
                                        <span class="font-icon glyphicon glyphicon-log-out" style="color: #FF5841;"></span>salir
                                    </a>
                                </div>
                            </div>
                        </div>
